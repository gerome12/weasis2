...
public class MainCanvas extends Canvas {
    ...
    static final Double WINDOW_DEFAULT = 700.0;
    static final Double LEVEL_DEFAULT = 300.0;
    static final Double MINIMUM_ZOOM_FACTOR = 0.5001;
    static final Double MAXIMUM_ZOOM_FACTOR = 20.0;
    static final String ZOOM_FACTOR_SCREEN = "zoomFactorScreen";
    static final String TRANSLATE_Y = "translateY";
    static final String TRANSLATE_X = "translateX";
    static final String PRESET_LIST_WINDOW_LEVEL = "PresetListWindowLevel";
    static final String IS_PRESET_WINDOW_LEVEL = "isPresetWindowLevel";
    static final String INFO_MODE = "infoMode";

    private Preferences prefs;

    MainCanvasTouchController canvasTouchController;
    MainCanvasMouseController canvasMouseController;
    MainCanvasScrollController canvasScrollController;
    MainCanvasKeyBoardController canvasKeyBoardController;
    ...
    Mesures mesures;
    BooleanProperty showMeasureProperty = new SimpleBooleanProperty(true);
    IntegerProperty measureInProgress = new SimpleIntegerProperty(0);
    BooleanProperty editModeProperty = new SimpleBooleanProperty(false);
    IntegerProperty indexNewWindowLevelKeyboardProperty = new SimpleIntegerProperty();
    ...
    public void setImage(DicomImageElement img) {
        if (img != null && img != sourceImage) {
            ...
            propagatePreset(img);
            image = SwingFXUtils.toFXImage(ImageProcessor.toBufferedImage(process()), null);
            draw();
        }
    }
    ...
    public void contraste(double deltaWindow, double deltaLevel) {
        if (image != null) {
            ImageOpNode node = manager.getNode(WindowOp.OP_NAME);
            if (node != null) {
                int imageDataType = ImageProcessor.convertToDataType(sourceImage.getImage().type());
